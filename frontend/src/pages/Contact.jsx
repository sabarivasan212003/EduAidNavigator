...
function Contact() {
    ...
    <div class="container px-5 py-5 ">
        <div>
            ...
            <h1 class="mt-1 text-2xl font-semibold text-gray-800 md:text-3xl dark:text-white">Chat to our friendly team</h1>

            <p class="mt-1 text-gray-500 dark:text-gray-400">We’d love to hear from you. Please fill out this form or shoot us an email.</p>
        </div>
        ...
        <div class="grid grid-cols-1 gap-12 mt-5 lg:grid-cols-2">
            ...
            <div class="py-6 rounded-lg bg-gray-10 dark:bg-gray-800 p-8">
                <form>
                    ...
                    <button class="w-full px-6 py-3 mt-16 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-500 rounded-lg hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                        Send message
                    </button>
                    <button onClick={hello}class="w-full px-6 py-3 mt-16 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-500 rounded-lg hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                        Back 
                    </button>
                </form>
            </div>
